...
![screenshot of Fruitris on the Adafruit Fruit Jam](https://raw.githubusercontent.com/relic-se/Fruit_Jam_Fruitris/main/assets/screenshot.png)

- Playground Guide: [https://adafruit-playground.com/u/relic_se/pages/fruit-jam-fruitris-tetris](https://adafruit-playground.com/u/relic_se/pages/fruit-jam-fruitris-tetris)
- Latest Release: [Download](https://github.com/relic-se/Fruit_Jam_Fruitris/releases/latest)
...
- Website: https://relic-se.github.io/Fruit_Jam_Pong/
- Playground Guide: [https://adafruit-playground.com](https://adafruit-playground.com)
- Latest Release: [Download](https://github.com/relic-se/Fruit_Jam_Pong/releases/latest)
...
![screenshot of the title screen](https://raw.githubusercontent.com/relic-se/Fruit_Jam_Ssspeed_Dating/main/assets/screenshot-title.jpg)

- Playground Guide: [https://adafruit-playground.com/u/relic_se/pages/fruit-jam-ssspeed-dating](https://adafruit-playground.com/u/relic_se/pages/fruit-jam-ssspeed-dating)
...
Color test pattern maker for Fruit Jam DVI display

![8-bit red palette](https://raw.githubusercontent.com/samblenny/fruit-jam-color-checker/main/png/8-bit-red.png)

- Latest Release: [Download](https://github.com/samblenny/fruit-jam-color-checker/releases/latest)
- Code Repository: [samblenny/fruit-jam-color-checker](https://github.com/samblenny/fruit-jam-color-checker)
- Author: [Sam Blenny](https://github.com/samblenny)

### Fruit Jam Gamepad Tester

USB gamepad tester for Fruit Jam

![screenshot of DVI output from Fruit Jam Gamepad Tester](https://raw.githubusercontent.com/samblenny/fruit-jam-gamepad-tester/main/fruit-jam-gamepad-tester-demo.png)

- Latest Release: [Download](https://github.com/samblenny/fruit-jam-gamepad-tester/releases/latest)
- Code Repository: [samblenny/fruit-jam-gamepad-tester](https://github.com/samblenny/fruit-jam-gamepad-tester)
- Author: [Sam Blenny](https://github.com/samblenny)

### Fruit Jam Two Gamepad Demo

Fruit Jam demo/tester thing for using two USB gamepads with asyncio

![screenshot of two gamepad visualizers](https://raw.githubusercontent.com/samblenny/fruit-jam-two-gamepad-demo/main/two-player-demo-screenshot.png)

- Latest Release: [Download](https://github.com/samblenny/fruit-jam-two-gamepad-demo/releases/latest)
- Code Repository: [samblenny/fruit-jam-two-gamepad-demo](https://github.com/samblenny/fruit-jam-two-gamepad-demo)
- Author: [Sam Blenny](https://github.com/samblenny)
...
hypotrochoid spiral drawing thing for Fruit Jam

![multi-color spiral curve on black background](https://raw.githubusercontent.com/samblenny/fruit-jam-spirals/main/img/curve-1.png)
