...
# Sourced from: https://github.com/Kitki30/micropython-zipfile-readonly
# Original lib from: https://github.com/jonnor/micropython-zipfile
...
class ZipFile:
    ...
    mode: The mode can be either read 'r'.
